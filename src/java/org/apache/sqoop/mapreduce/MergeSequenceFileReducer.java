 ...
 */
public class MergeSequenceFileReducer
    extends Reducer<Text, MergeRecord, LongWritable,SqoopRecord> {
  public static final Log LOG = LogFactory.getLog(MergeSequenceFileReducer.class.getName());
  ...
  public void reduce(Text key, Iterable<MergeRecord> vals, Context c)
    ...
    if (null != bestRecord) {
      c.write(new LongWritable(),bestRecord);
    }
  }
}
